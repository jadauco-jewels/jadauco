...
specs:
  ...
  setIncludes: 1 Ring
images:
  - src: ./rajwadi-pearl-bloom-ring-1.jpg
    alt: Rajwadi Pearl Bloom Ring — Gold finish with intricate detailing, Cubic Zirconia (CZ) and pearl-style detailing
inStock: true
featured: false
sequence: 23
archived: false
tags: [rajwadi, pearl bloom, ring, statement ring, CZ, pearl-style, festive, traditional, wedding, ethnic]
